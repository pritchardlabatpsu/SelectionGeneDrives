...
function output = SRG_20220916(pop_treat,mut,inf_eff,swtch_dly,dim_res,a_B,b,d,npats)
...
res_pops = boolean([0 1 1 1 0 1 1 1]);   % which populations are generally resistant? monitor for relapse
