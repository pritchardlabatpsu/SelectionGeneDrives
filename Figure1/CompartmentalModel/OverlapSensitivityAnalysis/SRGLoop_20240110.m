...
inf_eff_vec = .01; %[0 logspace(-3,-0.5,6)];
swtch_dly_vec = 365*(0:.3:4);
dim_res_vec = 0; % 0:0.02:0.14;
a_B_vec = 0:0.01:0.08; % default 0.04
trnovr_vec = 14; %[1 7 14 21]; % Default 14
ngr_vec = 0.01;  %[0.05 0.01 0.015 0.02 0.025]; % Default 0.01
                    ...
                    for a_B = a_B_vec
                        for trnovr = trnovr_vec
                            for ngr = ngr_vec
                                ...
                                out = SRG_20240110(pop_treat,mut,inf_eff,swtch_dly,dim_res,a_B,b,d,npats);
